...
import '../../modules/screens/3.home_screen.dart';
import '../../modules/screens/4.chats_screen.dart';
import '../../modules/screens/5.settings_screen.dart';
...
class ChatAppCubit extends Cubit<ChatAppState> {
  ...
  List<Widget> appBar = kCustomAppBar;
  int currentIndex = 0;
  UserModel? userModel;
        ...
        for (var user in users) {
          FirebaseFirestore.instance
            ...
            if (value.docs.isNotEmpty) {
              user.lastMessage = MessageModel.fromJson(value.docs.first.data());
            }
          });
        }
