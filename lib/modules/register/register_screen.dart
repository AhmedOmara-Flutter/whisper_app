...
import 'package:lost_project/modules/register/register_cubit/chat_register_cubit.dart';
import 'package:lost_project/modules/register/register_cubit/chat_register_state.dart';
      ...
      child: BlocConsumer<ChatRegisterCubit, ChatRegisterState>(
        listener: (context, state) {
          ...
          if (state is ChatCreateUserSuccessState) {
            ...
            snakeBar(
                context: context,
                text: 'Registration successful! Welcome to the app.',
                color: Colors.green);
